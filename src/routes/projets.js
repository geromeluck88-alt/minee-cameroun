...
const { projetToText } = require('../utils/textBuilders');
...
router.post(
  ...
  async (req, res) => {
    ...
    indexSafely({ type: 'projet', refId: projet.id, projetId: projet.id, content: projetToText(projet) });
